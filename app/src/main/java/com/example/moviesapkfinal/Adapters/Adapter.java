package com.example.moviesapkfinal.Adapters;
...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
    ...
    public Adapter(List<Movie> movieResponses, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holders, int position) {
        ...
        Movie movie = movieResponses.get(position);

        //displaying the image in holder
